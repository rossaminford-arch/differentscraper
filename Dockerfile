...
# Provide shub-image-info so Scrapy Cloud can discover runnable spiders
COPY shub-image-info /usr/local/bin/shub-image-info
RUN chmod +x /usr/local/bin/shub-image-info

# Contract scripts for custom images
