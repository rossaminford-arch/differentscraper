...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=os.getenv("ENTITY", "companies"),
        help="Which PitchBook directory to crawl (or set ENTITY env var)",
    )
parser.add_argument(
        "query",
        nargs="?",
        default=os.getenv("QUERY", "golf"),
        help="Search query (or set QUERY env var)",
    )
